...
/**
 * Inherited for Collection class, this class uses Arrays to store and manipulate with objects.
 * It has 4 constructors ,and the memory it uses is dynamically allocated.
 * @author Mateo
 *
 */
public class ArrayIndexedCollection extends Collection {
	 ...
	 *is invalid,it throws exception (IndexOutOfBoundsException).
	...
	/**
	 * Inserts the given value at the given position in array. The legal positions are 0 to size
	 *  (both are included). If position is invalid, function throws  (IndexOutOfBoundsException). 
	 * @param value inserts this Object in the array
	 * @param position inserts an object in this position
	 */
	 ...
	 *  the given value or -1 if the value is not found. Argument can be null 
	 *  ,in that case result is also -1 
	 * @param value the Object the function searches
	 ...
	 *  is on location index, etc. Legal indexes are 0 to size-1. 
	 *  In case of invalid index function throws (IndexOutOfBoundsException).
	 * @param index
	 */
